  ...
  const navbarHTML = `
    <nav>
      ...
      <ul class="nav-links" id="navLinksList">
        ...
        <li><a href="${prefix}projects/project.html" class="nav-projects"><svg class="nav-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h6v6H4zM14 5h6v6h-6zM4 15h6v5H4zM14 15h6v5h-6z"/></svg><span>Projects</span></a></li>
        ...
        <li><a href="${prefix}journal/journal.html" class="nav-daily-journal"><svg class="nav-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3h13a2 2 0 0 1 2 2v16H6a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3z"/><path d="M7 3v18M10 8h7M10 12h7M10 16h4"/></svg><span>Journal</span></a></li>
